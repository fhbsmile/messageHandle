 ...
 * @see com.tsystems.si.aviation.imf.messageHandle.db.bean.Flight
	...
	public Flight findById(java.lang.Integer id) {
		...
		try {
			Flight instance = (Flight) sessionFactory.getCurrentSession()
					.get("com.tsystems.si.aviation.imf.messageHandle.db.bean.Flight", id);
			if (instance == null) {
	...
	public List findByExample(Flight instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tsystems.si.aviation.imf.messageHandle.db.bean.Flight")
