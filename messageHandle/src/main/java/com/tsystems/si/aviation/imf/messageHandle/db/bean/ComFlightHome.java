 ...
 * @see com.tsystems.si.aviation.imf.messageHandle.db.bean.ComFlight
	...
	public ComFlight findById(java.lang.Integer id) {
		...
		try {
			ComFlight instance = (ComFlight) sessionFactory.getCurrentSession()
					.get("com.tsystems.si.aviation.imf.messageHandle.db.bean.ComFlight", id);
			if (instance == null) {
	...
	public List findByExample(ComFlight instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tsystems.si.aviation.imf.messageHandle.db.bean.ComFlight")
