 ...
 * @see com.tsystems.si.aviation.imf.messageHandle.db.bean.OrgMessage
	...
	public OrgMessage findById(java.lang.Integer id) {
		...
		try {
			OrgMessage instance = (OrgMessage) sessionFactory.getCurrentSession()
					.get("com.tsystems.si.aviation.imf.messageHandle.db.bean.OrgMessage", id);
			if (instance == null) {
	...
	public List findByExample(OrgMessage instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tsystems.si.aviation.imf.messageHandle.db.bean.OrgMessage")
